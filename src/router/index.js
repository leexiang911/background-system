...
export const constantRoutes = [
    ...
    children: [
      {
        path: 'index',
        name: 'slogan',
        component: () => import('@/views/home-page-slogan/index'),
...

  {
    ...
    name: 'Blog',
    meta: {
      title: '文章管理', icon: 'el-icon-notebook-2', auth: true
    },
    children: [
      {
        path: '/bloglist',
      ...
      },
      {
        ...
        hidden: true,//隐藏在侧边栏，不过这里没有meta对象，也不会显示
      }
    ]
  },

  {
    ...
    redirect: '/project',
    name: 'Project',
    meta: { title: '项目管理', icon: 'el-icon-s-order', auth: true },
    children: [
      {
        path: '/project-add',
        name: 'ProjectAdd',
      ...
      },
      {
        ...
        meta: { title: '项目列表', icon: 'el-icon-finished' }
      },
    ]
  },
